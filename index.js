...
require('./lib/server/controllers/BaseMigrateController.js');
require('./lib/server/controllers/MigrateController.js');
require('./lib/server/mysql/Connection.js');
require('./lib/server/mysql/QueryBuilder.js');
require('./lib/server/mysql/Schema.js');
