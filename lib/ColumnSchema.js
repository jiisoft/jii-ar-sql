 ...
 */
Jii.defineClass('Jii.sql.ColumnSchema', {
	...
	typecast: function(value) {
		if (value === '' && this.type !== Jii.sql.mysql.BaseSchema.TYPE_TEXT &&
			this.type !== Jii.sql.mysql.BaseSchema.TYPE_STRING &&
			this.type !== Jii.sql.mysql.BaseSchema.TYPE_BINARY) {
			return null;
		}
