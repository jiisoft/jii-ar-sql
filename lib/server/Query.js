 ...
 */
Jii.defineClass('Jii.sql.Query', /** @lends Jii.sql.Query.prototype */{

	__extends: 'Jii.base.Component',

	__static: /** @lends Jii.sql.Query */{
	...
	addSelect: function (columns) {
		...
		if (this._select === null) {
			...
			this._select = Jii._.isArray(columns) ?
				...
				Jii._.extend(columns, this._select);
		}
		return this;
	},
	...
	_filterCondition: function (condition) {
		if (!Jii._.isObject(condition) && !Jii._.isArray(condition)) {
			return condition;
		}
	...
	_normalizeOrderBy: function (columns) {
		if (Jii._.isObject(columns) && !Jii._.isArray(columns)) {
			return columns;
		}
