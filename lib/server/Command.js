 ...
 */
Jii.defineClass('Jii.sql.Command', /** @lends Jii.sql.Command.prototype */{
    ...
    insertModel: function(model, values) {
        return this.insert(model.__static.tableName(), values);
    },
    ...
    updateModel: function(model, values) {
        ...
        return this.update(model.__static.tableName(), values, condition);
    },
    ...
    deleteModel: function(model) {
        var condition = model.getOldPrimaryKey(true);
        return this.delete(model.__static.tableName(), condition);
    },
