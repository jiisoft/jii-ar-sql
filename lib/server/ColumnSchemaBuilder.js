 ...
 */
Jii.defineClass('Jii.sql.ColumnSchemaBuilder', /** @lends Jii.sql.ColumnSchemaBuilder.prototype */{
     ...
     */
    constructor: function (type, length, config) {
        length = length || null;
        config = config || [];
     ...
     * @returns {Jii.sql.ColumnSchemaBuilder}
     */
    defaultExpression: function (value) {
     ...
     * @returns {string}
     */
    _buildLengthString: function () {
        if (this._length === null || (Jii._.isArray(this._length) && this._length.length === 0)) {
            return '';
        }
