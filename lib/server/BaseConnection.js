 ...
 */
Jii.defineClass('Jii.sql.BaseConnection', /** @lends Jii.sql.BaseConnection.prototype */{

	__extends: 'Jii.base.Component',

	__static: /** @lends Jii.sql.BaseConnection */{
		/**
	...
	/**
	 * @type {Jii.sql.BaseSchema} the database schema
	 */
	_schema: null,
	 ...
	 * @returns {Jii.sql.BaseSchema} the schema information for the database opened by this connection.
	 */
	getSchema: function () {
		if (this._schema === null) {
			var config = Jii._.isString(this.schemaClass) ?
	 ...
	 * @returns {Jii.sql.QueryBuilder} the query builder for the current DB connection.
	 */
     ...
     * @returns {{}}
     */
    getModelSchemaJson: function(tableNames) {
