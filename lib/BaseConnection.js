 ...
 */
Jii.defineClass('Jii.sql.BaseConnection', {
	...
	/**
	 * @type {Jii.sql.Schema} the database schema
	 */
	_schema: null,
	 ...
	 * @returns {Jii.sql.Schema} the schema information for the database opened by this connection.
	 */
	getSchema: function () {
	 ...
	 * @returns {Jii.when} table schema information. Null if the named table does not exist.
	 */
