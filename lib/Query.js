...
Jii.defineClass('Jii.sql.Query', {
	...
	all: function (db) {
		...
		return this.createCommand(db).queryAll().then(function(rows) {
	...
	count: function (q, db) {
		...
		return this._queryScalar('COUNT(' + q + ')', db).then(function(count) {
	...
	sum: function (q, db) {
		...
		return this._queryScalar("SUM(q)", db);
	},
	...
	average: function (q, db) {
		...
		return this._queryScalar("AVG(q)", db);
	},
	...
	min: function (q, db) {
		...
		return this._queryScalar("MIN(q)", db);
	},
	...
	max: function (q, db) {
		...
		return this._queryScalar("MAX(q)", db);
	},
	...
	setDistinct: function() {
		return this.distinct.apply(this, arguments);
	},
	 ...
	 */
	setIndexBy: function() {
		return this.indexBy.apply(this, arguments);
	},
	 ...
	 */
	setOrderBy: function() {
		return this.orderBy.apply(this, arguments);
	},
