...
Jii.defineClass('Jii.sql.QueryBuilder', {
	...
	buildCondition: function(condition, params) {
		...
		if (condition[0]) { // operator format: operator, operand 1, operand 2, ...
			...
			if (Jii._.has(this._conditionBuilders, operator)) {
	...
	buildBetweenCondition: function(operator, operands, params) {
		...
		var phName1 = this.__static.PARAM_PREFIX + Jii._.size(params);
		params[phName1] = value1;
		var phName2 = this.__static.PARAM_PREFIX + Jii._.size(params);
