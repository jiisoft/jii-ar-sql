 ...
 */
Jii.defineClass('Jii.sql.QueryBuilder', /** @lends Jii.sql.QueryBuilder.prototype */{
	...
	build: function(query, params) {
		...
		return query.prepare(this).then(function(query) {
			params = Jii._.extend(params, query.getParams());
			return Promise.all([
	...
	buildGroupBy: function(columns) {
		return Promise.resolve(Jii._.isEmpty(columns) ? '' : 'GROUP BY ' + this.buildColumns(columns));
	},
	...
	buildLimit: function(limit, offset) {
		...
		return Promise.resolve(Jii._s.ltrim(sql));
	},
