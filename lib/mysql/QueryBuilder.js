 ...
 */
Jii.defineClass('Jii.sql.mysql.QueryBuilder', {
	...
	typeMap: (function() {
		var map = {};
		map[Jii.sql.BaseSchema.TYPE_PK] = 'int(11) NOT NULL AUTO_INCREMENT PRIMARY KEY';
		map[Jii.sql.BaseSchema.TYPE_BIGPK] = 'bigint(20) NOT NULL AUTO_INCREMENT PRIMARY KEY';
		map[Jii.sql.BaseSchema.TYPE_STRING] = 'varchar(255)';
		map[Jii.sql.BaseSchema.TYPE_TEXT] = 'text';
		map[Jii.sql.BaseSchema.TYPE_SMALLINT] = 'smallint(6)';
		map[Jii.sql.BaseSchema.TYPE_INTEGER] = 'int(11)';
		map[Jii.sql.BaseSchema.TYPE_BIGINT] = 'bigint(20)';
		map[Jii.sql.BaseSchema.TYPE_FLOAT] = 'float';
		map[Jii.sql.BaseSchema.TYPE_DECIMAL] = 'decimal(10,0)';
		map[Jii.sql.BaseSchema.TYPE_DATETIME] = 'datetime';
		map[Jii.sql.BaseSchema.TYPE_TIMESTAMP] = 'timestamp';
		map[Jii.sql.BaseSchema.TYPE_TIME] = 'time';
		map[Jii.sql.BaseSchema.TYPE_DATE] = 'date';
		map[Jii.sql.BaseSchema.TYPE_BINARY] = 'blob';
		map[Jii.sql.BaseSchema.TYPE_BOOLEAN] = 'tinyint(1)';
		map[Jii.sql.BaseSchema.TYPE_MONEY] = 'decimal(19,4)';
		return map;
	})(),
	...
	dropForeignKey: function (name, table) {
		return Jii.when.resolve('ALTER TABLE ' + this.db.quoteTableName(table) +
	...
	dropPrimaryKey: function (name, table) {
		return Jii.when.resolve('ALTER TABLE ' + this.db.quoteTableName(table) + ' DROP PRIMARY KEY');
	},
	...
	resetSequence: function (tableName, value) {
		...
		return Jii.when.resolve('ALTER TABLE ' + quoteTableName + ' AUTO_INCREMENT=' + parseInt(value));
	},
	...
	checkIntegrity: function (check, schema, table) {
		...
		return Jii.when.resolve('SET FOREIGN_KEY_CHECKS = ' + (check ? 1 : 0));
	},
